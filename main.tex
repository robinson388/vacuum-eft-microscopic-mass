...
\title{\textbf{Local Mass Generation via Holographic Vacuum Response:}\\
\large Spin-$\frac{1}{2}$ Topology and the Lepton Mass Hierarchy as Boundary Attractors}

\author{\textbf{Robinson Bueno Parra}\\[0.5em]
\small\textit{Department of Theoretical Physics / Independent Research}\\[0.2em]
\small\texttt{robinbuenoparra8@gmail.com}\\[0.2em]
\small ORCID: \texttt{0009-0009-7434-8468}\\[0.5em]
\small GitHub Repository: \texttt{https://github.com robinson388/vacio-eft-masa-leptona}\\[0.2em]
\small Zenodo Digital Repository DOI: \texttt{10.5281/zenodo.21631097}}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.7\textwidth]{lepton_hierarchy.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.7\textwidth]{vacuum_prediction.png}
